...
export const IconContainer = ({
  ...
  return (
    ...
    >
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-700 bg-slate-800 shadow-inner group transition-transform hover:scale-110">
        {icon || (
      ...
      <div className="hidden rounded-md px-2 py-1 md:block bg-black/20 backdrop-blur-sm border border-white/5">
